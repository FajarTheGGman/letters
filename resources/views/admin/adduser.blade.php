            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item">Role Users</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <button class='btn btn-warning pb-2' data-target='#add' data-toggle='modal' >
                        Add Admin
                    </button>
                    ...
                    <div class='card mt-3'>
                        <table class='card-body table'>
                            ...
                            <tr>
                                ...
                                <td>{{ $x->firstname }}</td>
                                <td>{{ $x->role }}</td>
                                <td><button type="button" data-target="#edit" class='btn btn-warning' data-toggle='modal'><span class='fas fa-edit'></span></button></td>
                            </tr>
                            @endforeach
