...
! function() {
                ...
                for (S["@"] && (h = S["@"].attributes, v = S["@"].attributesOrder), t = 0, n = w.length; t < n; t++)
                    if (i = y.exec(w[t])) {
                        if (g = i[1], c = i[2], p = i[3], s = i[5], a = {
                            ...
                            for (r = 0, o = (s = Zr(s, "|")).length; r < o; r++)(i = C.exec(s[r])) && (u = {}, f = i[1], l = i[2].replace(/[\\:]:/g, ":"), g = i[3], b = i[4], "!" === f && (a.attributesRequired = a.attributesRequired || [], a.attributesRequired.push(l), u.required = !0), "-" !== f ? (g && ("=" === g && (a.attributesDefault = a.attributesDefault || [], a.attributesDefault.push({
                                name: l,
                                value: b
    ...
    var co = Tr(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        ai = (ui.prototype.bind = function(e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                for (var m = t.split(" "), g = m.length; g--;) c = o, s = l = !1, "DOMContentLoaded" === (u = m[g]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, so({
                    type: u
    ...
    function Xf(e, t, n, r) {
        Wf(e, t, e.dom.defaultView.innerHeight, n, r);
        var o, i, a, u, s, c, l, f = (o = n.element, u = Jt(Nt.fromDom(document)), a = (i = _d).owner(o), s = kd(i, a), c = Un(o), l = P(s, function(e, t) {
                var n = Un(t);
                return {
                    left: e.left + n.left,
                    top: e.top + n.top
                    ...
                    if (!M || (f = $.getElementRule(i))) {
                        if (d = !0, M && (p = f.attributes, h = f.attributePatterns), (g = t[9]) ? ((l = -1 !== g.indexOf("data-mce-type")) && F && (d = !1), (c = []).map = {}, g.replace(B, function(e, t, n, r, o) {
                            ...
                            if (v = f.attributesRequired, b = f.attributesDefault, y = f.attributesForced, f.removeEmptyAttrs && !c.length && (d = !1), y)
                                for (r = y.length; r--;) a = (m = y[r]).name, "{$uid}" === (C = m.value) && (C = "mce_" + E++), c.map[a] = C, c.push({
                                    name: a,
                                    value: C
                                });
                            if (b)
                                for (r = b.length; r--;)(a = (m = b[r]).name) in c.map || ("{$uid}" === (C = m.value) && (C = "mce_" + E++), c.map[a] = C, c.push({
                                    name: a,
                                    value: C
                                }));
                            if (v) {
    ...
    function Ip(u, s, c, e, l) {
        ...
        if ("false" !== h.getContentEditable(r.getNode())) r.isCollapsed() && dl(g) && !_l(u).length ? jg(u, s, c, l) : (Bl(r, !0, function() {
            Ol(u, t)
        }), dl(g) && Bg(u, s, c, r.getStart()) && Zc(h, r, r.getRng()), u.nodeChanged()), yf(u, s, e, c);
        else {
            e = r.getNode();
    ...
    function Kh(L, I) {
        ...
        return (t = U).addAttributeFilter("data-mce-tabindex", function(e, t) {
            ...
            serialize: function(e, t) {
                ...
                return "tree" === T.format ? B : (N = I, k = T, _ = B, D = nm(L, F).serialize(_), k.no_events || !N ? D : (A = N, R = _e(_e({}, k), {
                    content: D
    ...
    function v1(t, e) {
        ...
        N = k, (E = t).addCommand("delete", function() {
            ...
            ! function(e) {
                ...
                state: r
            }), y.on(r ? "keydown" : "keyup", S), y.off(r ? "keyup" : "keydown", S)))
    ...
    function b1(e, t) {
        ...
        return e.contentAreaContainer = t.iframeContainer, e.iframeElement = u, e.iframeHTML = function(e) {
            ...
            return ws(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + ws(e) + '" />'), t + ('</head><body id="' + n + '" class="mce-content-body ' + r + '" data-id="' + e.id) + '" aria-label=""><br></body></html>'
...
! function() {
    ...
    var i, c, s, u, d, l, m = (i = "string", function(t) {
            return t = typeof(e = t), (null === e ? "null" : "object" == t && (Array.prototype.isPrototypeOf(e) || e.constructor && "Array" === e.constructor.name) ? "array" : "object" == t && (String.prototype.isPrototypeOf(e) || e.constructor && "String" === e.constructor.name) ? "string" : t) === i;
            var e
        }),
    ...
    u = null !== (d = tinymce.defaultOptions) && void 0 !== d ? d : tinymce.defaultSettings, d = {
        load: o
    }, l = function(t) {
        t = t.api_key;
        return m(t) ? t : void 0
